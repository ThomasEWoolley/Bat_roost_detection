...
p1=plot(max(Tabledata.XCoordinate)+1000, ...
    mean(Tabledata.YCoordinate), ...
    'ko',LineWidth=1,MarkerFaceColor='auto');
plot(max(Tabledata.XCoordinate)+1000, ...
    mean(Tabledata.YCoordinate), ...
    'ko',LineWidth=1,MarkerFaceColor='auto');
...
export_fig('../Pictures/Detection_points_outside.png','-r300')