...
Names={'260616','250716','050916'};
Tabledata=table();
for j=1:length(Names)

    Loader = load(['./Roost_data/buckfastleigh/',Names{j},'_90min_calls.mat']);
    Tabledata=[Tabledata;Loader.T];
...
save('./Roost_data/buckfastleigh/Altogether_error_surface.mat')