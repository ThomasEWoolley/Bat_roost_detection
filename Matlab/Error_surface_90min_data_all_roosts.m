...
for j=1:length(Places)
    ...
    toc
    save(['./Roost_data/',Places{j},'/',Names{j},'_error_surface_90min_calls_1_90.mat'])
...
for j=1:length(Detector_position_vec)
    ...
    Detec(j)=integral(@(t)f3(15,Detector_position_vec(j,1),Detector_position_vec(j,2),zx,zy,81.7,t),1,90*60);
end
