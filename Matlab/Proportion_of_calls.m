...
Full_time_int(i)=integral3(@(r,theta,t)f1(r,theta,xi(i),0,80,t).*r,0,15,0,2*pi,1,90*60);
Approx_time_int(i)=integral3(@(r,theta,t)f2(r,theta,xi(i),0,80,t).*r,0,15,0,2*pi,1,90*60);
end
